#!/bin/bash
# iplocator v1.0
# Coded by: N17R063N (You dont become a coder by just changing the credits)
# Github: https://github.com/N17R063N/iplocator
...
command -v php > /dev/null 2>&1 || { echo >&2 "php not installed. Install it. Aborting."; exit 1; }



command -v curl > /dev/null 2>&1 || { echo >&2 "curl not installed. Install it. Aborting."; exit 1; }
...
command -v ssh > /dev/null 2>&1 || { echo >&2 "SSH not installed. Install it. Aborting."; exit 1; }
if [[ -e sendlink ]]; then
rm -rf sendlink
fi
...
command -v wget > /dev/null 2>&1 || { echo >&2 "wget not installed. Install it. Aborting."; exit 1; }
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "unzip not installed. Install it. Aborting."; exit 1; }
...
printf "\e[1;93m (_)          _    \e[0m\e[1;77m_      _           \e[0m\n"
printf "\e[1;77m  _   ____   | |  ___    ____  _____  _| |_  ___    ____  \e[0m\n"
printf "\e[1;77m | | |  _ \  | | / _ \  / ___)(____ |(_   _)/ _ \  / ___) \e[0m\n"
printf "\e[1;77m | | | |_| | | || |_| |( (___ / ___ |  | |_| |_| || |     \e[0m\n"
printf "\e[1;77m |_| | ___/  |_| \___/  \____)\_____|   \__)\___/ |_|       \e[0m\n"
printf "\e[1;77m     |_|                                             ]"'    v1.0 \e[0m\n"
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: @N17R063N\e[0m\n"
